...
def pi_info(host: str, user: str, ssh_key: str):
    ...
    with RaspberryPiManager(host, user, ssh_key_path=ssh_key) as pi:
        ...
        if info.load_average:
            print(f"  Load Avg:     {info.load_average[0]:.2f}, {info.load_average[1]:.2f}, {info.load_average[2]:.2f}")
...
def main():
    ...
    # Raspberry Pi commands
        ...
        ssh_key = input("SSH Key Path (default: ~/.ssh/pi_github_actions): ").strip() or "~/.ssh/pi_github_actions"
