...
class TestOpenSearchOperations:
    ...
    def test_index_alert_mock(self, mock_opensearch_client):
        ...
        result = mock_opensearch_client.index(
            index="ids2-alerts-2026.02.02",
            body=alert
        )
    ...
    def test_bulk_index_mock(self, mock_opensearch_client):
        ...
        mock_opensearch_client.bulk = Mock(return_value={
            "took": 30,
            "errors": False,
    ...
    def test_search_alerts_mock(self, mock_opensearch_client):
        ...
        mock_opensearch_client.search = Mock(return_value={
            "hits": {
                "total": {"value": 5},
